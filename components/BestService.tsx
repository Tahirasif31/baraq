    ...
    <div className="flex lg:flex-row flex-col mx-auto xl:max-w-[1080px] md:max-w-[1000px] py-[100px] lg:gap-3 gap-8 px-5 items-center">
      <div className="md:px-5 px-1">
        ...
        <p className="md:mt-3 mt-2">
          Welcome to AL BARAQ FACILITIES, your go-to destination for affordable
        ...
        <p className="md:mt-2 mt-1">
          At AL BARAQ FACILITIES, we prioritize transparency and affordability.
        ...
        <p className="mt-2 hidden md:block">
          Don&apos;t let AC problems disrupt your comfort any longer. Trust AL
          BARAQ FACILITIES for reliable repairs at prices that won&apos;t strain
